...
Public Class EmployeeDetails
    ...
    Dim cs As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Collage;Integrated Security=True;"
    'StrConnection = "Data Source=.;Initial Catalog=Collage;Integrated Security=True"
